...
parser.add_argument(
    ...
    default=None,
    help=(
        "Number of recurrent body layers. Defaults to a compute-compensated "
        "depth derived from --compute-equivalent-layers and --num-iterations."
    ),
)
parser.add_argument(
    "--num-iterations",
...
if args.n_layer is None:
    raise ValueError("--n_layer is required")
DEPTH = args.n_layer
MAX_SEQ_LEN = 2048
WINDOW_PATTERN = "SSSL"
